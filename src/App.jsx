    ...
    <main className="card">
      {!user ? (
        ...
        <section className="dashboard">
          ...
          {insights && (
            <>
              <div className="dashboard-sub-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                <h3 style={{ margin: 0, color: '#f8fafc', fontSize: '1.1rem' }}>Report: {since} to {until}</h3>
                <div className="export-actions" aria-label="Export options" style={{ marginBottom: '0' }} style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-end', marginBottom: '1.5rem' }}>
                    ...
                    <table className="sortable-table">
                      <thead>
                        <tr>
                          ...
                          <th onClick={() => requestSort('engagement')} className="sortable-header" title="Sort by Engagements">Engagements{getSortIcon('engagement')}</th>
